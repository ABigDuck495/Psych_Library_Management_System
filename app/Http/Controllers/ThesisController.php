     ...
     public function update(Request $request, Thesis $thesis)
    {
        ...
        try {
            ...
            if ($request->hasFile('pdf_file')) {
                ...
                // Store the file using 'thesis' disk
                $newPdfPath = $pdfFile->storeAs('', $filename, 'thesis');
                ...
                // Add PDF path to thesis data
                $thesisData['thesis_pdf'] = $newPdfPath;
            }
            ...
            if ($desired > $existing) {
                ...
                // Remove copies (only available ones without active transactions)
            ...
            // Delete old PDF if a new one was uploaded successfully
            ...
            // Clean up newly uploaded PDF if transaction fails
            if (isset($newPdfPath)) {
                Storage::disk('thesis')->delete($newPdfPath);
            }

            return redirect()->back()->withErrors('Failed to update thesis: ' . $e->getMessage())->withInput();
        }
    }
