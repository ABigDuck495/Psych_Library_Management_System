...
@section('title', 'Add Thesis - Psych Library')
...
<div class="flex-1 p-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-2">Add a new thesis to the library collection</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
        <form action="{{ route('theses.store') }}" method="POST" id="thesisForm" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex items-center mb-6 pb-4 border-b border-gray-200">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-800">Thesis Information</h2>
                    <p class="text-gray-600 text-sm">Enter the thesis details below</p>
                </div>
            </div>
            ...
            <div class="border-t border-gray-200 pt-6 mb-6">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Add authors for this thesis</p>
                    </div>
                </div>
    ...
    <div class="bg-purple-50 rounded-xl p-6 border border-purple-200">
        <div class="flex items-start">
            ...
            <div class="ml-4">
                <h3 class="text-lg font-medium text-purple-800">Quick Tips</h3>
                <div class="mt-2 text-purple-700 text-sm">
                    <ul class="list-disc list-inside space-y-1">
                        ...
                        <li>Upload PDF file for digital access (optional)</li>
                    </ul>
                </div>
            </div>
        </div>
